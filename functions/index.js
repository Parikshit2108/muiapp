...
const transporter = nodemailer.createTransport({
  service: "Gmail",
  auth: {user: config.user.email, pass: "eodmbkdqsfymrsse"},
});
...
exports.sendEmail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    ...
    if (total) {
      if (category) {
        mailOptions = {
          ...mailOptions,
          to: "parikshitfirebase@gmail.com",
          subject: "Estimste recieved",
          ...
          <p style="font-size:16px">Service:${selectedService}</p>
        ...
        mailOptions = {
          ...
          <p style="font-size:16px">Total:${total}</p>
          <p style="font-size:16px">Service:${selectedService}</p>
          <p style="font-size:16px">Platforms:${platform}</p>
          <p style="font-size:16px">Features:${features}</p>
          <p style="font-size:16px">CustomFeature:${customFeature}</p>
                                  ...
                                  <td align="center" style="padding:40px 10px">
                                    ...
                                    >
                                      ...
                                      <tr>
                                        ...
                                        >
                                          <a
                                            href="mailto:parikshitfirebase@gmail.com"
                                            style="color:#ffffff; text-decoration:none!important"
                                            >From: Parikshit patil</a
                                          >
                                        </td>
                                      </tr>
                                    </table>
  ...
  //   functions.logger.info("Hello logs!", {structuredData: true});
  //   response.send("Hello from Firebase!");eodmbkdqsfymrsse
});

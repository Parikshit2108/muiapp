  ...
  return (
    <>
      <Grid container direction={"column"} className={classes.mainContainer}>
        <Head>
          <title key="title">
            Custom Software, mobile Apps and Websites | Arc Developement
          </title>{" "}
          <meta
            name="description"
            key="description"
            content="Pristine software custom-designed from the ground up with cutting-edge optimization.use our free estimate calculator to get the cost of your project"
          />
          <meta
            property="og:title"
            content="Bringin West Coast technology to the Midwest | Arc Developement"
            key="og:title"
          />

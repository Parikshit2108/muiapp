...
import estimateAnim from "../src/animations/estimateAnimation/data.json";
  ...
  return (
    <div>
      <Grid container direction={"row"}>
        <Head>
          <title key="title">
            Free Custom Software Estimate | Arc Developement
          </title>{" "}
          <meta
            name="description"
            key="description"
            content="Use our Free online estimate calculator to instantly check the cost of your custom software,mobile app, or website design and developement project!"
          />
          <meta
            property="og:title"
